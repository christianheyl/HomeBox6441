...
#ifndef __MKIMG_HEAD_H__
#define __MKIMG_HEAD_H__
...
#define CHUNKSZ_SHA1 (64 * 1024)
  ...
  #define cpu_to_be32(x)		(x)
...
#ifdef CONFIG_HDR_MKIMG
	#define IMG_HDR_LEN			(0x80)
	#define MKIMG_LEN			(sizeof(image_header_t))
	#define SECBOOT_LEN			(1<<11)
	#define ARCBOOT_LEN			(1<<14)
	#define SKIP_LEN			(MKIMG_LEN)
	...
	#define endian_swap(x)		(((x>>24)&0xff)|((x<<8)&0xff0000)|		\
								((x>>8)&0xff00) |((x<<24)&0xff000000))
	#define be32_to_cpu(x)		endian_swap(x)
	#define cpu_to_be32(x)		endian_swap(x)
#endif	// CONFIG_HDR_MKIMG //
...
int image_print_contents (const void *hdr);
