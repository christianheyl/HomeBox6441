...
/*==========================================================================*/
/* PMCU VERSION DEFINITION 														*/
/*==========================================================================*/
/** driver version, major number */
#define DRV_PMCU_VER_MAJOR 2
/** driver version, minor number */
#define DRV_PMCU_VER_MINOR 1
/** driver version, build number */
#define DRV_PMCU_VER_STEP 10
/** driver version, package type */
#define DRV_PMCU_VER_TYPE 2

#define PMCU_VERSION(a,b,c,d) (((a) << 24) + ((b) << 16) + ((c) << 8) + (d))
#define PMCU_VERSION_CODE PMCU_VERSION(DRV_PMCU_VER_MAJOR,DRV_PMCU_VER_MINOR,DRV_PMCU_VER_STEP,DRV_PMCU_VER_TYPE)
