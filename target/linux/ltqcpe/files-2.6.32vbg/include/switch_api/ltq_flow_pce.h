...
typedef enum
{
	...
	LTQ_ETHSW_PCE_IPDALSB_INDEX		= 0x14,
	LTQ_ETHSW_PCE_IPSALSB_INDEX		= 0x15,
	LTQ_ETHSW_PCE_MACDA_INDEX		= 0x16,
	LTQ_ETHSW_PCE_MACSA_INDEX		= 0x17,
	LTQ_ETHSW_PCE_FLOWPTR_INDEX		= 0x18,
	LTQ_ETHSW_PCE_PARS_INDIVIDUAL_INDEX	= 0x19,
	LTQ_ETHSW_PCE_SPCP_INDEX		= 0x1A,
	LTQ_ETHSW_PCE_MSTP_INDEX		= 0x1B,
	LTQ_ETHSW_PCE_EGREMARK_INDEX	= 0x1C
