...
******************************************************************************/
#ifndef _GSWIP_SWITCH_H
#define _GSWIP_SWITCH_H
/* -------------------------------------------------------------------------- */
...
#define GSWIP_TIMER_FS_LSB_FSLSB_OFFSET					0x020
#define GSWIP_TIMER_FS_LSB_FSLSB_SHIFT					0
#define GSWIP_TIMER_FS_LSB_FSLSB_SIZE					15
/* -------------------------------------------------------------------------- */
/* Bits: FSMSB	*/
/* Description: Timer Fractional Nano Second MSB Value  */
#define GSWIP_TIMER_FS_MSB_FSMSB_OFFSET					0x021
#define GSWIP_TIMER_FS_MSB_FSMSB_SHIFT					0
#define GSWIP_TIMER_FS_MSB_FSMSB_SIZE					16
/* -------------------------------------------------------------------------- */
/* Bits: NSLSB	*/
/* Description: Timer Nano Second LSB Register  */
#define GSWIP_TIMER_NS_LSB_NSLSB_OFFSET					0x022
#define GSWIP_TIMER_NS_LSB_NSLSB_SHIFT					0
#define GSWIP_TIMER_NS_LSB_NSLSB_SIZE					16
/* -------------------------------------------------------------------------- */
/* Bits: NSMSB	*/
/* Description: Timer Nano Second MSB Register  */
#define GSWIP_TIMER_NS_MSB_NSMSB_OFFSET					0x023
#define GSWIP_TIMER_NS_MSB_NSMSB_SHIFT					0
#define GSWIP_TIMER_NS_MSB_NSMSB_SIZE					16
/* -------------------------------------------------------------------------- */
/* Bits: SECLSB	*/
/* Description: Timer Second LSB Register  */
#define GSWIP_TIMER_SEC_LSB_SECLSB_OFFSET				0x024
#define GSWIP_TIMER_SEC_LSB_SECLSB_SHIFT				0
#define GSWIP_TIMER_SEC_LSB_SECLSB_SIZE					16
/* -------------------------------------------------------------------------- */
/* Bits: SECMSB	*/
/* Description: Timer Second MSB Register  */
#define GSWIP_TIMER_SEC_MSB_SECMSB_OFFSET				0x025
#define GSWIP_TIMER_SEC_MSB_SECMSB_SHIFT				0
#define GSWIP_TIMER_SEC_MSB_SECMSB_SIZE					16
/* -------------------------------------------------------------------------- */
/* Bit: WR	*/
/* Description: Write to Timer Command  */
#define GSWIP_TIMER_CTRL_WR_OFFSET						0x026
#define GSWIP_TIMER_CTRL_WR_SHIFT						15
#define GSWIP_TIMER_CTRL_WR_SIZE						1
/* Bit: RD	*/
/* Description: Read from Timer Command  */
#define GSWIP_TIMER_CTRL_RD_OFFSET						0x026
#define GSWIP_TIMER_CTRL_RD_SHIFT						14
#define GSWIP_TIMER_CTRL_RD_SIZE						1
/* Bit: ADJ	*/
/* Description: Adjust Timer Command  */
#define GSWIP_TIMER_CTRL_ADJ_OFFSET						0x026
#define GSWIP_TIMER_CTRL_ADJ_SHIFT						13
#define GSWIP_TIMER_CTRL_ADJ_SIZE						1
/* -------------------------------------------------------------------------- */
/* Register: 'RAM Value Register 4' */
/* Bit: 'VAL4' */
/* Description: 'Data value [15:0]' */
#define GSWIP_BM_RAM_VAL_4_VAL4_OFFSET				0x03F
#define GSWIP_BM_RAM_VAL_4_VAL4_SHIFT				0
#define GSWIP_BM_RAM_VAL_4_VAL4_SIZE				16
/* -------------------------------------------------------------------------- */
...
#define VR9_BM_QUEUE_GCTRL_GL_MOD_SIZE				2
/* Bit: 'AQUI' */
...
/* Bit: 'QCGN' */
/* Description: 'Egress Queue Congestion Status Change Interrupt Enable' */
#define GSWIP_BM_IER_QCGN_OFFSET						0x054
#define GSWIP_BM_IER_QCGN_SHIFT							8
#define GSWIP_BM_IER_QCGN_SIZE							1
/* Bit: 'CNT4' */
...
#define GSWIP_BM_ISR_EQCGN_OFFSET					0x055
#define GSWIP_BM_ISR_EQCGN_SHIFT					8
#define GSWIP_BM_ISR_EQCGN_SIZE						1
/* Bit: 'CNT4' */
...
/* -------------------------------------------------------------------------- */
/* Register: 'BM Egress Queue Congestion Notification Status Register 0' */
/* Bit: 'EQCGN0' */
/* Description: 'Egress Queue Congestion Notification Queue 15 to 0' */
#define GSWIP_BM_EQCGN0_EQCGN0_OFFSET					0x059
#define GSWIP_BM_EQCGN0_EQCGN0_SHIFT					0
#define GSWIP_BM_EQCGN0_EQCGN0_SIZE						16
/* -------------------------------------------------------------------------- */
/* Register: 'BM Egress Queue Congestion Notification Status Register 1' */
/* Bit: 'EQCGN1' */
/* Description: 'Egress Queue Congestion Notification Queue 31 to 16' */
#define GSWIP_BM_EQCGN1_EQCGN1_OFFSET					0x05A
#define GSWIP_BM_EQCGN1_EQCGN1_SHIFT					0
#define GSWIP_BM_EQCGN1_EQCGN1_SIZE						16
/* -------------------------------------------------------------------------- */
...
#define GSWIP_BM_EQCGN2_EQCGN2_OFFSET					0x05B
#define GSWIP_BM_EQCGN2_EQCGN2_SHIFT					0
#define GSWIP_BM_EQCGN2_EQCGN2_SIZE						8
/* -------------------------------------------------------------------------- */
/* Register: 'BM WFQ and Shaper Overhead Byte Configuration' */
/* Bit: 'OVERHD' */
/* Description: 'BM WFQ and Shaper Overhead Byte' */
#define GSWIP_BM_OVERHD_OVERHD_OFFSET					0x061
#define GSWIP_BM_OVERHD_OVERHD_SHIFT					0
#define GSWIP_BM_OVERHD_OVERHD_SIZE						8
/* -------------------------------------------------------------------------- */
...
#define GSWIP_BM_RMON_CTRL_BCAST_CNT_OFFSET				0x081
#define GSWIP_BM_RMON_CTRL_BCAST_CNT_SHIFT				2
#define GSWIP_BM_RMON_CTRL_BCAST_CNT_SIZE				1
/* Bit: 'RAM2_RES' */
...
/* -------------------------------------------------------------------------- */
/* Register: 'WRED Port Red Threshold Register 0' */
/* Bit: 'MINTH' */
/* Description: 'Minimum Threshold' */
#define GSWIP_BM_PWRED_RTH_0_MINTH_OFFSET                  0x0A0
#define GSWIP_BM_PWRED_RTH_0_MINTH_SHIFT                   0
#define GSWIP_BM_PWRED_RTH_0_MINTH_SIZE                    10
/* -------------------------------------------------------------------------- */
/* Register: 'WRED Port Red Threshold Register 1' */
/* Bit: 'MAXTH' */
/* Description: 'Minimum Threshold' */
#define GSWIP_BM_PWRED_RTH_1_MAXTH_OFFSET                  0x0A1
#define GSWIP_BM_PWRED_RTH_1_MAXTH_SHIFT                   0
#define GSWIP_BM_PWRED_RTH_1_MAXTH_SIZE                    10
/* -------------------------------------------------------------------------- */
/* Register: 'WRED Port Yellow Threshold Register 0' */
/* Bit: 'MINTH' */
/* Description: 'Minimum Threshold' */
#define GSWIP_BM_PWRED_YTH_0_MINTH_OFFSET                  0x0A2
#define GSWIP_BM_PWRED_YTH_0_MINTH_SHIFT                   0
#define GSWIP_BM_PWRED_YTH_0_MINTH_SIZE                    10
/* -------------------------------------------------------------------------- */
/* Register: 'WRED Port Yellow Threshold Register 1' */
/* Bit: 'MAXTH' */
/* Description: 'Minimum Threshold' */
#define GSWIP_BM_PWRED_YTH_1_MAXTH_OFFSET                  0x0A3
#define GSWIP_BM_PWRED_YTH_1_MAXTH_SHIFT                   0
#define GSWIP_BM_PWRED_YTH_1_MAXTH_SIZE                    10
/* -------------------------------------------------------------------------- */
/* Register: 'WRED Port Green Threshold Register 0' */
/* Bit: 'MINTH' */
/* Description: 'Minimum Threshold' */
#define GSWIP_BM_PWRED_GTH_0_MINTH_OFFSET                  0x0A4
#define GSWIP_BM_PWRED_GTH_0_MINTH_SHIFT                   0
#define GSWIP_BM_PWRED_GTH_0_MINTH_SIZE                    10
/* -------------------------------------------------------------------------- */
/* Register: 'WRED Port Green Threshold Register 1' */
/* Bit: 'MAXTH' */
/* Description: 'Minimum Threshold' */
#define GSWIP_BM_PWRED_GTH_1_MAXTH_OFFSET                  0x0A5
#define GSWIP_BM_PWRED_GTH_1_MAXTH_SHIFT                   0
#define GSWIP_BM_PWRED_GTH_1_MAXTH_SIZE                    10
/* -------------------------------------------------------------------------- */
...
#define GSWIP_RS_CTRL_RSMOD_OFFSET					0x140
#define GSWIP_RS_CTRL_RSMOD_SHIFT					1
#define GSWIP_RS_CTRL_RSMOD_SIZE					1
/* Bit: 'RSEN' */
...
/* Bit: 'VAL6' */
/* Description: 'Data value [15:0]' */
#define GSWIP_PCE_TBL_VAL_6_VAL6_OFFSET					0x436
#define GSWIP_PCE_TBL_VAL_6_VAL6_SHIFT					0
#define GSWIP_PCE_TBL_VAL_6_VAL6_SIZE					16
/* -------------------------------------------------------------------------- */
/* Register: 'Table Value Register5' */
/* Bit: 'VAL5' */
/* Description: 'Data value [15:0]' */
#define GSWIP_PCE_TBL_VAL_5_VAL5_OFFSET					0x437
#define GSWIP_PCE_TBL_VAL_5_VAL5_SHIFT					0
#define GSWIP_PCE_TBL_VAL_5_VAL5_SIZE					16
/* -------------------------------------------------------------------------- */
...
#define GSWIP_PCE_TBL_CTRL_EXTOP_OFFSET				0x44F
#define GSWIP_PCE_TBL_CTRL_EXTOP_SHIFT				14
#define GSWIP_PCE_TBL_CTRL_EXTOP_SIZE					1
/* Bit: 'TYPE' */
...
#define GSWIP_PCE_GCTRL_1_VLANMD_OFFSET				0x457
#define GSWIP_PCE_GCTRL_1_VLANMD_SHIFT				9
#define GSWIP_PCE_GCTRL_1_VLANMD_SIZE					1
/* Bit: 'UKIPMC' */
/* Description: 'Unknown IP Multicast Forwardng Mode' */
#define GSWIP_PCE_GCTRL_1_UKIPMC_OFFSET				0x457
#define GSWIP_PCE_GCTRL_1_UKIPMC_SHIFT				8
#define GSWIP_PCE_GCTRL_1_UKIPMC_SIZE				1
/* Bit: 'SPFMOD' */
/* Description: 'Port Spoofing Detection Violation Forwarding Mode' */
#define GSWIP_PCE_GCTRL_1_SPFMOD_OFFSET				0x457
#define GSWIP_PCE_GCTRL_1_SPFMOD_SHIFT				7
#define GSWIP_PCE_GCTRL_1_SPFMOD_SIZE				1
/* Bit: 'FLOWPTR_LIST_EN' */
...
#define GSWIP_PCE_IER_1_CHG_OFFSET				0x466
#define GSWIP_PCE_IER_1_CHG_SHIFT				7
#define GSWIP_PCE_IER_1_CHG_SIZE				1
/* Bit: 'FLOWINT' */
...
#define GSWIP_PCE_ISR_1_CHG_OFFSET					0x468
#define GSWIP_PCE_ISR_1_CHG_SHIFT					7
#define GSWIP_PCE_ISR_1_CHG_SIZE					1
/* Bit: 'FLOWINT' */
...
#define GSWIP_PCE_CGDMAC_NUM_OFFSET							0x46A
#define GSWIP_PCE_CGDMAC_NUM_SHIFT							0
#define GSWIP_PCE_CGDMAC_NUM_SIZE								12
/* -------------------------------------------------------------------------- */
/* Register: 'PCE Trunking Distribution Number' */
/* Bit: 'DIP' */
/* Description: 'Destination IP Mask' */
#define GSWIP_PCE_TRUNK_CONF_DIP_OFFSET					0x46B
#define GSWIP_PCE_TRUNK_CONF_DIP_SHIFT					3
#define GSWIP_PCE_TRUNK_CONF_DIP_SIZE					1
/* Bit: 'SIP' */
/* Description: 'Source IP Mask' */
#define GSWIP_PCE_TRUNK_CONF_SIP_OFFSET					0x46B
#define GSWIP_PCE_TRUNK_CONF_SIP_SHIFT					2
#define GSWIP_PCE_TRUNK_CONF_SIP_SIZE					1
/* Bit: 'DA' */
/* Description: 'Destination MAC Mask' */
#define GSWIP_PCE_TRUNK_CONF_DA_OFFSET					0x46B
#define GSWIP_PCE_TRUNK_CONF_DA_SHIFT					1
#define GSWIP_PCE_TRUNK_CONF_DA_SIZE					1
/* Bit: 'SA' */
/* Description: 'Source MAC Mask' */
#define GSWIP_PCE_TRUNK_CONF_SA_OFFSET					0x46B
#define GSWIP_PCE_TRUNK_CONF_SA_SHIFT					0
#define GSWIP_PCE_TRUNK_CONF_SA_SIZE					1
/* -------------------------------------------------------------------------- */
/* Register: 'PCE Meter Shaper Overhead Byte Configuration' */
/* Bit: 'OVERHD' */
/* Description: 'PCE Meter Overhead Byte' */
#define GSWIP_PCE_OVERHD_OVERHD_OFFSET					0x46C
#define GSWIP_PCE_OVERHD_OVERHD_SHIFT					0
#define GSWIP_PCE_OVERHD_OVERHD_SIZE					8
/* -------------------------------------------------------------------------- */
/* Register: 'PCE Port ControlRegister 0' */
/* Bit: 'MSTP' */
/* Description: 'Multiple STP Instance Enable' */
#define GSWIP_PCE_PCTRL_0_MSTP_OFFSET					0x480
#define GSWIP_PCE_PCTRL_0_MSTP_SHIFT					15
#define GSWIP_PCE_PCTRL_0_MSTP_SIZE						1
/* Bit: 'SPFDIS' */
/* Description: 'Port Spoofing Detection' */
#define GSWIP_PCE_PCTRL_0_SPFDIS_OFFSET					0x480
#define GSWIP_PCE_PCTRL_0_SPFDIS_SHIFT					14
#define GSWIP_PCE_PCTRL_0_SPFDIS_SIZE					1
/* Bit: 'MCST' */
...
/* Bit: 'SDEIEN' */
/* Description: 'STAG DEI Remarking Mode' */
#define GSWIP_PCE_PCTRL_2_SDEIEN_OFFSET					0x482
#define GSWIP_PCE_PCTRL_2_SDEIEN_SHIFT					10
#define GSWIP_PCE_PCTRL_2_SDEIEN_SIZE						1
/* Bit: 'SPCPEN' */
/* Description: 'STAG PCP Remarking Mode' */
#define GSWIP_PCE_PCTRL_2_SPCPEN_OFFSET					0x482
#define GSWIP_PCE_PCTRL_2_SPCPEN_SHIFT					9
#define GSWIP_PCE_PCTRL_2_SPCPEN_SIZE						1
/* Bit: 'SPCP' */
/* Description: 'Enable VLAN STAG PCP and DEI to select the Class of Service' */
#define GSWIP_PCE_PCTRL_2_SPCP_OFFSET					0x482
#define GSWIP_PCE_PCTRL_2_SPCP_SHIFT					8
#define GSWIP_PCE_PCTRL_2_SPCP_SIZE						1
/* Bit: 'DSCPMOD' */
...
#define GSWIP_PCE_PCTRL_3_LNDIS_OFFSET				0x483
#define GSWIP_PCE_PCTRL_3_LNDIS_SHIFT				15
#define GSWIP_PCE_PCTRL_3_LNDIS_SIZE				1
/* Bit: 'IGPTRM' */
/* Description: 'Ingress Port Removal Disable' */
#define GSWIP_PCE_PCTRL_3_IGPTRM_OFFSET				0x483
#define GSWIP_PCE_PCTRL_3_IGPTRM_SHIFT				14
#define GSWIP_PCE_PCTRL_3_IGPTRM_SIZE				1
/* Bit: 'VIO_9' */
/* Description: 'New MAC-Port Association Mirroring Enable' */
#define GSWIP_PCE_PCTRL_3_VIO_9_OFFSET				0x483
#define GSWIP_PCE_PCTRL_3_VIO_9_SHIFT				13
#define GSWIP_PCE_PCTRL_3_VIO_9_SIZE				1
/* Bit: 'VIO_8' */
...
#define GSWIP_PCE_PIER_MTEBP_OFFSET					0x488
#define GSWIP_PCE_PIER_MTEBP_SHIFT					8
#define GSWIP_PCE_PIER_MTEBP_SIZE					1
/* Bit: 'SPFINT' */
/* Description: 'Port Spoofing Alert Interrupt Enable' */
#define GSWIP_PCE_PIER_SPFINT_OFFSET				0x488
#define GSWIP_PCE_PIER_SPFINT_SHIFT					7
#define GSWIP_PCE_PIER_SPFINT_SIZE					1
/* Bit: 'FRZDRP' */
...
#define GSWIP_PCE_PISR_MTEBP_OFFSET					0x489
#define GSWIP_PCE_PISR_MTEBP_SHIFT					8
#define GSWIP_PCE_PISR_MTEBP_SIZE					1
/* Bit: 'SPFINT' */
/* Description: 'Port Spoofing Alert Interrupt' */
#define GSWIP_PCE_PISR_SPFINT_OFFSET				0x489
#define GSWIP_PCE_PISR_SPFINT_SHIFT					7
#define GSWIP_PCE_PISR_SPFINT_SIZE					1
/* Bit: 'FRZDRP' */
...
/* -------------------------------------------------------------------------- */
/* Register: 'PCE Port Trunking Register' */
/* Bit: 'EN' */
/* Description: 'Port Trunking Enable' */
#define GSWIP_PCE_PTRUNK_EN_OFFSET						0x521
#define GSWIP_PCE_PTRUNK_EN_SHIFT						15
#define GSWIP_PCE_PTRUNK_EN_SIZE						1
/* Bit: 'PARTER' */
/* Description: 'Port Trunking Partner Port ID' */
#define GSWIP_PCE_PTRUNK_PARTER_OFFSET					0x521
#define GSWIP_PCE_PTRUNK_PARTER_SHIFT					0
#define GSWIP_PCE_PTRUNK_PARTER_SIZE					4
/* -------------------------------------------------------------------------- */
/* Register: 'Three-colorMarker Control Register' */
/* Bit: 'TEBYP' */
/* Description: 'Te Bucket Check Bypass' */
#define GSWIP_PCE_TCM_CTRL_TEBYP_OFFSET				0x580
#define GSWIP_PCE_TCM_CTRL_TEBYP_SHIFT				1
#define GSWIP_PCE_TCM_CTRL_TEBYP_SIZE				1
/* Bit: 'TCMEN' */
...
#define GSWIP_PCE_TCM_STAT_MTEBP_OFFSET				0x581
#define GSWIP_PCE_TCM_STAT_MTEBP_SHIFT				2
#define GSWIP_PCE_TCM_STAT_MTEBP_SIZE				1
/* Bit: 'AL1' */
...
#define GSWIP_MAC_LPITMER0_TMLSB_OFFSET					0x909
#define GSWIP_MAC_LPITMER0_TMLSB_SHIFT					0
#define GSWIP_MAC_LPITMER0_TMLSB_SIZE					16
/* -------------------------------------------------------------------------- */
/* Register: 'MAC LPI Timer Register 1' */
/* Bit: 'TMMSB' */
/* Description: 'MAC LPI Timer MSB' */
#define GSWIP_MAC_LPITMER1_TMMSB_OFFSET					0x90A
#define GSWIP_MAC_LPITMER1_TMMSB_SHIFT					0
#define GSWIP_MAC_LPITMER1_TMMSB_SIZE					16
/* -------------------------------------------------------------------------- */
/* Register: 'MAC Test Enable Register' */
/* Bit: 'LPITM' */
/* Description: 'LPI Monitoring Mode' */
#define GSWIP_MAC_TESTEN_LPITM_OFFSET				0x90B
#define GSWIP_MAC_TESTEN_LPITM_SHIFT				8
#define GSWIP_MAC_TESTEN_LPITM_SIZE					2
/* Bit: 'JTEN' */
...
#define GSWIP_FDMA_CTRL_RMMD_OFFSET				0xA40
#define GSWIP_FDMA_CTRL_RMMD_SHIFT				8
#define GSWIP_FDMA_CTRL_RMMD_SIZE					1

/* Bit: 'RMMD' */
/* Description: 'Remarking Mode' */
#define GSWIP_FDMA_CTRL_EGCNT_OFFSET                        0xA40
#define GSWIP_FDMA_CTRL_EGCNT_SHIFT                         8
#define GSWIP_FDMA_CTRL_EGCNT_SIZE                          1
/* Bit: 'EGCNT' */
...
/* -------------------------------------------------------------------------- */
/* Register: 'SDMA Interrupt Enable Register 1' */
/* Bit: 'CGNBP' */
/* Description: 'Ingress Port Congestion Based Back Pressure Status Change' */
#define GSWIP_SDMA_IER_1_CGNBP_OFFSET					0xB4D
#define GSWIP_SDMA_IER_1_CGNBP_SHIFT					0
#define GSWIP_SDMA_IER_1_CGNBP_SIZE						7
/* -------------------------------------------------------------------------- */
/* Register: 'SDMA Interrupt Enable Register 1' */
/* Bit: 'CGNBP' */
/* Description: 'Ingress Port Congested Based Backpressure Status Change' */
#define GSWIP_SDMA_ISR_1_CGNBP_OFFSET					0xB4E
#define GSWIP_SDMA_ISR_1_CGNBP_SHIFT					0
#define GSWIP_SDMA_ISR_1_CGNBP_SIZE						7
/* -------------------------------------------------------------------------- */
/* Register: 'SDMA Congestion Backpressure Status Register' */
/* Bit: 'CGNBP' */
/* Description: 'Ingress Port Congestion Based Back Pressure Status' */
#define GSWIP_SDMA_CGNBP_CGNBP_OFFSET					0xB4F
#define GSWIP_SDMA_CGNBP_CGNBP_SHIFT					0
#define GSWIP_SDMA_CGNBP_CGNBP_SIZE						7
/* -------------------------------------------------------------------------- */
/* Register: 'Ethernet SwitchStore DMA Port Control Register' */
/* Bit: 'SFDSTB' */
/* Description: 'Drop Threshold Selection' */
#define GSWIP_SDMA_PCTRL_SFDSTB_OFFSET				0xBC0
#define GSWIP_SDMA_PCTRL_SFDSTB_SHIFT					15
#define GSWIP_SDMA_PCTRL_SFDSTB_SIZE					1
/* Bit: 'DTHR' */
/* Description: 'Drop Threshold Selection' */
...
/* -------------------------------------------------------------------------- */
/* -------------------------------------------------------------------------- */
/* Register: 'Ingress Port Flow Control Threshold 8 Register' */
/* Bit: 'THR8' */
/* Description: 'Threshold 8' */
#define GSWIP_SDMA_PFCTHR8_THR8_OFFSET					0xC0E
#define GSWIP_SDMA_PFCTHR8_THR8_SHIFT					0
#define GSWIP_SDMA_PFCTHR8_THR8_SIZE					11
/* -------------------------------------------------------------------------- */
/* -------------------------------------------------------------------------- */
/* Register: 'Ingress Port Flow Control Threshold 9 Register' */
/* Bit: 'THR9' */
/* Description: 'Threshold 8' */
#define GSWIP_SDMA_PFCTHR9_THR9_OFFSET					0xC0F
#define GSWIP_SDMA_PFCTHR9_THR9_SHIFT					0
#define GSWIP_SDMA_PFCTHR9_THR9_SIZE					11
/* -------------------------------------------------------------------------- */
#endif /* #ifndef _GSWIP_SWITCH_H */
