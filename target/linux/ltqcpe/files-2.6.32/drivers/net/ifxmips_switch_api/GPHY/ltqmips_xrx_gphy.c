...
#if defined(CONFIG_AR10_FAMILY_BOARD_2) || defined(CONFIG_LTQ_VRX220)
...
#endif
#if  ( defined(CONFIG_VR9) || defined(CONFIG_AR10) || defined(CONFIG_AR10_GRX390) )
#ifndef CONFIG_GEFE_MIXED_MODE
...
#endif  /*CONFIG_VR9 || CONFIG_AR10 || CONFIG_AR10_GRX390*/
...
#if defined(CONFIG_LTQ_VRX220) 
                       	else if (lq_ethsw_mdio_data_read(phyaddr, SWITCH_STATUS_REG) & LINK_ON)
#else
...
#if defined(CONFIG_AR10) || defined(CONFIG_LTQ_VRX220)
...
int ifx_phy_module_init (void)
{
	...
	ifx_get_chipid(&chipID);
                printk(KERN_ERR "\n GPHY:!!!!  chip-ID :%x, chipID.family_ver:%x",chipID.family_id,chipID.family_ver);
#ifdef CONFIG_LTQ_VRX220
        dev_id=1;
