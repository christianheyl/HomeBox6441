...
const IFX_ll_fkt ifx_ethsw_FLOW_fkt_ptr_tbl [] =
{
	/* 0x00 */
	(IFX_ll_fkt) IFX_NULL,
   ...
   /* Command: IFX_ETHSW_MMD_DATA_READ ; Index: 0x5F */
	(IFX_ll_fkt) IFX_FLOW_MmdDataRead,
	/* Command: IFX_ETHSW_MMD_DATA_WRITE ; Index: 0x60 */
	(IFX_ll_fkt) IFX_FLOW_MmdDataWrite,
   ...
   (IFX_ll_fkt) IFX_FLOW_TrunkingCfgGet,
   /* Command: IFX_ETHSW_TRUNKING_CFG_SET ; Index: 0x66 */
   (IFX_ll_fkt) IFX_FLOW_TrunkingCfgSet,
   /* Command: IFX_ETHSW_TRUNKING_PORT_CFG_GET ; Index: 0x67 */
   (IFX_ll_fkt) IFX_FLOW_TrunkingPortCfgGet,
   /* Command: IFX_ETHSW_TRUNKING_PORT_CFG_SET ; Index: 0x68 */
   (IFX_ll_fkt) IFX_FLOW_TrunkingPortCfgSet,
   /* Command: IFX_ETHSW_QOS_WRED_PORT_CFG_SET ; Index: 0x69 */
   (IFX_ll_fkt) IFX_ETHSW_SW_FKT( CONFIG_LTQ_QOS , IFX_FLOW_QoS_WredPortCfgSet),
    /* Command: IFX_ETHSW_QOS_WRED_PORT_CFG_GET ; Index: 0x6a */
    (IFX_ll_fkt) IFX_ETHSW_SW_FKT( CONFIG_LTQ_QOS , IFX_FLOW_QoS_WredPortCfgGet),
   /* Command: IFX_ETHSW_QOS_FLOWCTRL_CFG_SET ; Index: 0x6b */
   (IFX_ll_fkt) IFX_ETHSW_SW_FKT( CONFIG_LTQ_QOS , IFX_FLOW_QoS_FlowctrlCfgSet),
   /* Command: IFX_ETHSW_QOS_FLOWCTRL_CFG_GET ; Index: 0x6c */
   (IFX_ll_fkt) IFX_ETHSW_SW_FKT( CONFIG_LTQ_QOS , IFX_FLOW_QoS_FlowctrlCfgGet),
      /* Command: IFX_ETHSW_QOS_FLOWCTRL_PORT_CFG_SET ; Index: 0x6d */
      (IFX_ll_fkt) IFX_ETHSW_SW_FKT( CONFIG_LTQ_QOS , IFX_FLOW_QoS_FlowctrlPortCfgSet),
   /* Command: IFX_ETHSW_QOS_FLOWCTRL_PORT_CFG_GET ; Index: 0x6e */
   (IFX_ll_fkt) IFX_ETHSW_SW_FKT( CONFIG_LTQ_QOS , IFX_FLOW_QoS_FlowctrlPortCfgGet),
	/* Command: IFX_ETHSW_QOS_QUEUE_BUFFER_RESERVE_CFG_SET ; Index: 0x6f */
	(IFX_ll_fkt) IFX_ETHSW_SW_FKT( CONFIG_LTQ_QOS , IFX_FLOW_QoS_QueueBufferReserveCfgSet),
   /* Command: IFX_ETHSW_QOS_QUEUE_BUFFER_RESERVE_CFG_GET ; Index: 0x70 */
   (IFX_ll_fkt) IFX_ETHSW_SW_FKT( CONFIG_LTQ_QOS , IFX_FLOW_QoS_QueueBufferReserveCfgGet),
   
};

const IFX_ETHSW_lowLevelFkts_t ifx_ethsw_FLOW_fkt_tbl =
{
   IFX_NULL , /* pNext */
...
const IFX_ll_fkt ifx_flow_fkt_ptr_tbl [] =
{
	/* 0x00 */
	(IFX_ll_fkt) IFX_NULL,
   ...
   (IFX_ll_fkt) IFX_FLOW_TimestampTimerSet,
   /* Command: IFX_FLOW_TIMESTAMP_TIMER_GET ; Index: 0x0D */
   (IFX_ll_fkt) IFX_FLOW_TimestampTimerGet,
   /* Command: IFX_FLOW_TIMESTAMP_PORT_READ ; Index: 0x0E */
   (IFX_ll_fkt) IFX_FLOW_TimestampPortRead,
};

const IFX_ETHSW_lowLevelFkts_t ifx_flow_fkt_tbl =
{
