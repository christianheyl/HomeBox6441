...
#define __QOS_NEW_FEATURE                        SB_BUFFER(0x2F9A)
#define MAX_SHAPER_NUM                          8
#define WTX_EG_Q_DEF_SHAPER_ADDR                (0x3BD4)
#define WTX_EG_Q_SHAPER_ADDR(i)                 (0x3BD8 + ((i) << 2))      /* i < 8 */
...
#define WTX_EG_Q_SHAPER_MAPPING_CFG(i)          ((volatile struct wtx_q_shaper_mapping_cfg *) SB_BUFFER(0x20A8 + (i)))

/* Minimum Bandwidth Reservation Negative BitMap */
#define WTX_EG_Q_SHAPER_WEIGHT_NEGATIVE_MAP     SB_BUFFER(0x2F90)

/* MBR Shaper to Queue Mapping */
#define WTX_EG_Q_DEF_SHAPER_QUEUE_MAP           SB_BUFFER(0x2F91)
#define WTX_EG_Q_SHAPER_QUEUE_MAP(i)            SB_BUFFER(0x2F92 + (i))  /* 0 <= i < 8 */
...
#if defined(L2TP_CONFIG) && L2TP_CONFIG
#define __L2TPTUNNLEL_CONFIG_TABLE_BASE		0x2040
