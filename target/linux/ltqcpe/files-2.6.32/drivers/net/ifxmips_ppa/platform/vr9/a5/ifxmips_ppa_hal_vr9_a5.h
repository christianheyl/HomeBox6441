...
#if defined(L2TP_CONFIG) && L2TP_CONFIG
#define __L2TPTUNNEL_CONFIG_TABLE_BASE		0x4230
#define L2TPTUNNEL_CONFIG_TBL(i)                ((volatile struct l2tptunnel_config_tbl *) SB_BUFFER(__L2TPTUNNEL_CONFIG_TABLE_BASE + (i) * 12))
#endif
