...
#define MAX_PEERID_NUM      528
#define MAX_PEER_NUM        128
#define MAX_VAP_NUM         16
#define MAX_INV_HEADER_LEN  256
...
extern int ppa_dl_dre_wlan_pkt_send(unsigned int rxpb_ptr, unsigned int data_len, unsigned int pktstatus, unsigned int msg_ptr, unsigned int flags);
