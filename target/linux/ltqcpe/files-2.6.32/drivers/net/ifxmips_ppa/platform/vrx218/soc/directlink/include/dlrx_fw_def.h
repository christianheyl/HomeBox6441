...
//1 dword?
#define DLRX_TARGET_CE5_READ_INDEX                      (volatile unsigned int *)(pcie_base + (0x58848>>2))

// 1 dword?
#define DLRX_TARGET_CE5_WRITE_INDEX                     (volatile unsigned int *)(pcie_base + (0x58840>>2))
