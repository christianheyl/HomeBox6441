...
extern int32_t ifx_ppa_set_qos_rate( uint32_t portid, uint32_t queueid, int32_t shaperid, uint32_t rate, uint32_t burst, uint32_t flag );
extern int32_t ifx_ppa_get_qos_rate( uint32_t portid, uint32_t queueid, int32_t* shaperid, uint32_t *rate, uint32_t *burst, uint32_t flag);
#else
...
#if defined(MBR_CONFIG) && MBR_CONFIG
extern int32_t ifx_ppa_set_qos_shaper( int32_t shaperid, uint32_t rate, uint32_t burst );
extern int32_t ifx_ppa_get_qos_shaper( int32_t *shaperid, uint32_t *rate, uint32_t *burst, uint32_t flag);
