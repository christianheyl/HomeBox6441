...
/********************************************************************************************** 
  * PPA Extra ethernet interface  hook function :ppa_hook_directpath_register_dev_fn
...
int32_t (*ppa_hook_directpath_send_spec_fn)(uint32_t, PPA_BUF *, int32_t, uint32_t) = NULL;
//--Add by Maxx_chen
#endif
...
int32_t (*ifx_ppa_hook_set_qos_rate)( uint32_t portid, uint32_t queueid, int32_t shaperid, uint32_t rate, uint32_t burst, uint32_t flag) = NULL;
int32_t (*ifx_ppa_hook_get_qos_rate)( uint32_t portid, uint32_t queueid, int32_t* shaperid, uint32_t *rate, uint32_t *burst, uint32_t flag) = NULL;
...
//++Add by Maxx_chen
/* ARCADYAN #ARC_RC_SD2#, 2013/4/16, Dino, Make specific PPA path(rmv redundent) for wireless drv */
EXPORT_SYMBOL(ppa_hook_directpath_send_spec_fn);
//--Add by Maxx_chen
#endif
