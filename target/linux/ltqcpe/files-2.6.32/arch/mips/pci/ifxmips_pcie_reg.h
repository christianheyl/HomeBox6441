...
/*
#define PCIE_RC_CORE_COMBINED_INT 0x00000020
*/
...
#define PCIE_CEMR(X)                        (volatile u32*)(PCIE_RC_PORT_TO_BASE(X) + 0x114)

/* Advanced Error Capabilities and Control Register */
#define PCIE_AECCR(X)                       (volatile u32*)(PCIE_RC_PORT_TO_BASE(X) + 0x118)
