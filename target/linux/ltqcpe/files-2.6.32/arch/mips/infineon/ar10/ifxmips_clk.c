 ...
 */
#define CGU_SYS_CPU_FS			GET_BITS(*IFX_CGU_SYS, 10, 9)
...
inline u32 ifx_get_ddr_hz(void)
{
    ...
    switch ( *IFX_CGU_SYS & (0x03 << 9) )
    {
        case (0 << 9): sys_clk = CLOCK_600M; break;
        case (1 << 9): sys_clk = CLOCK_666M; break;
        case (2 << 9): sys_clk = CLOCK_720M; break;
        default:       sys_clk = CLOCK_600M; break;
    }
#else
...
#elif defined (CONFIG_AR10_GRX390)
    switch (CGU_SYS_CPU_FS)
    {
        case (0): sys_clk = CLOCK_600M; break;
        case (1): sys_clk = CLOCK_666M; break;
        case (2): sys_clk = CLOCK_720M; break;
        default:  return CLOCK_600M;
    }
#else
    switch ( *IFX_CGU_SYS & (0x01 << 8) )
    {
