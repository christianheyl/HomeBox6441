...
/*==========================================================================*/
/* CPUFREQ VERSION DEFINITION 														*/
/*==========================================================================*/
/** driver version, major number */
#define DRV_CPUFREQ_VER_MAJOR 3
/** driver version, minor number */
#define DRV_CPUFREQ_VER_MINOR 0
/** driver version, build number */
#define DRV_CPUFREQ_VER_STEP 13
/** driver version, package type */
#define DRV_CPUFREQ_VER_TYPE 0

#define CPUFREQ_VERSION(a,b,c,d) (((a) << 24) + ((b) << 16) + ((c) << 8) + (d))
#define CPUFREQ_VERSION_CODE CPUFREQ_VERSION(DRV_CPUFREQ_VER_MAJOR, \
        DRV_CPUFREQ_VER_MINOR,DRV_CPUFREQ_VER_STEP,DRV_CPUFREQ_VER_TYPE)
