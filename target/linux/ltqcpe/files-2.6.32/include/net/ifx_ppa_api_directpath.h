...
/*!
    ...
    \note
*/
int32_t ifx_ppa_directlink_register_dev(int32_t *if_id, PPA_DTLK_T *dtlk, PPA_DIRECTPATH_CB *pDirectpathCb, uint32_t flags);
#endif
...
*/
    ...
    int32_t ifx_ppa_directpath_reinject_from_imq(int32_t rx_if_id, PPA_BUF *buf, int32_t len, uint32_t flags);
...
//++Add by Maxx_chen
  ...
  int32_t ifx_ppa_directpath_send_spec(uint32_t rx_if_id, PPA_BUF *buf, int32_t len, uint32_t flags);
//--Add by Maxx_chen
#endif
...
/*!  \brief   This function allows the device driver to indicate to the PPA that it cannot receive any further packets from the latter. The device driver can call this function for flow control.
    ...
    \return  The return value can be any one of the following:  \n
		-	IFX_SUCCESS on sucess \n
		-	IFX_FAILURE
    \note   1. Even if the return value is IFX_FAILURE , skb will be freed by PPA. Don't reuse this skb for any purpose\n
