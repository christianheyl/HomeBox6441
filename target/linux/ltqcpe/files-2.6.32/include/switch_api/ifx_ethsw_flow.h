...
typedef struct
{
   ...
   /** Port BitMap Mux control */
	IFX_boolean_t 										bPortBitMapMuxControl;
	/** Trunking action enable  */
	IFX_boolean_t 										bPortTrunkAction;
	/**  Port Link Selection control */
	IFX_boolean_t 										bPortLinkSelection;
   /** Action "Flow ID".
...
typedef struct
{
   ...
   IFX_uint8_t                                        nPortId;
   /** Second. Absolute second timer count. */
   IFX_uint32_t                                       nIngressSec;
   /** Nano Second. Absolute nano second timer count. */
   IFX_uint32_t                                       nIngressNanoSec;
   /** Second. Absolute second timer count. */
   IFX_uint32_t                                       nEgressSec;
   /** Nano Second. Absolute nano second timer count. */
   IFX_uint32_t                                       nEgressNanoSec;
