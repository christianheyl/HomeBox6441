...
#endif /*CONFIG_AR10 */
#define GFS_ADD3					(VRX_RCU_BASE_ADDR + 0x264)  /*GRX 390 */
...
#define MDIO_STAT_0					(GSWIP_BASE_ADDR + (0xC56 * 4))
/* Description: 'Ethernet MAC Interrupt Enable' */
#define VR9_ETHSW_IER		(GSWIP_BASE_ADDR + (0x14 * 4))
/* Register: 'MAC Interrupt EnableRegister' */
/* Bit: 'MACIEN' */
/* Description: 'MAC Interrupt Enable' */
#define VR9_MAC_IER_MACIEN		(GSWIP_BASE_ADDR + (0x8C8 * 4))
	/* MAC Port Status Register */
#define VR9_MAC_PSTAT		(GSWIP_BASE_ADDR + (0x900 * 4))
/* MAC Interrupt Status Register */
#define VR9_MAC_PISR		(GSWIP_BASE_ADDR + (0x901 * 4))
 /* MAC Interrupt Enable Register  */
#define VR9_MAC_PIER		(GSWIP_BASE_ADDR + (0x902 * 4))
 /*  Configured the IPG value  */
#define VR9_MAC_CTRL_1		(GSWIP_BASE_ADDR + (0x904 * 4))
