...
#		fi		
	...
	# Init QUANTENNA RGMII 11ac module 
        if [ "$CONFIG_PACKAGE_QUANTENNA_TYPE_SINGLE_RGMII" = "1" -o "$CONFIG_PACKAGE_QUANTENNA_TYPE_TWO_RGMII" = "1" ]; then
		/etc/rc.d/qtn_wlan_init
        fi
