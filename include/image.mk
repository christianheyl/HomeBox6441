...
define prepare_generic_squashfs
	...
	dd if=$(KDIR)/tmpfile.3 of=$(1) bs=128k conv=sync
...
define Image/mkfs/prepare/default
	- $(FIND) $(TARGET_DIR) -type f -not -perm -u+x -not -name 'ssh_host*' -print0 | $(XARGS) -0 chmod 0644
	- $(FIND) $(TARGET_DIR) -type f -perm -u+x -print0 | $(XARGS) -0 chmod 0755
	- $(FIND) $(TARGET_DIR) -type d -print0 | $(XARGS) -0 chmod 0755
        # Terry 20130731, /tmp will be created in 'Image/mkfs/prepare/platform'.
