...
## linghong_tan 2014-04-30. Add libxt_connlimit.so to conntrack-extra
$(eval $(call nf_add,IPT_CONNTRACK_EXTRA,CONFIG_IP_NF_MATCH_CONNBYTES, $(P_V4)ipt_connlimit))
$(eval $(call nf_add,IPT_CONNTRACK_EXTRA,CONFIG_NETFILTER_XT_MATCH_CONNBYTES, $(P_XT)xt_connlimit))
# u32
$(eval $(call nf_add,IPT_U32,CONFIG_IP_NF_MATCH_U32, $(P_V4)ipt_u32))
...
$(eval $(call nf_add,IPT_NFLOG,CONFIG_NETFILTER_XT_TARGET_NFLOG, $(P_XT)ipt_NFLOG))
