...
GENERIC_FILES_DIR := $(foreach dir,$(if $(wildcard $(GENERIC_PLATFORM_DIR)/files-$(KERNEL_PATCHVER)),$(wildcard $(GENERIC_PLATFORM_DIR)/files-$(KERNEL_PATCHVER)),$(wildcard $(GENERIC_PLATFORM_DIR)/files)),"$(dir)")
...
LINUX_CONFCMD=$(if $(LINUX_CONFIG), \
	...
	$(SCRIPT_DIR)/kconfig.pl \
		...
		$(if $(ARC_LINUX_CONFIG),+ $(ARC_LINUX_CONFIG),) \
