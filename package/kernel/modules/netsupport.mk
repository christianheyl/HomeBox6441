...
#
# For Advance Routing, support multi WAN
#
define KernelPackage/advance_route
 SUBMENU:=$(NETWORK_SUPPORT_MENU)
 TITLE:=MultiWAN support
 KCONFIG += \
       CONFIG_IP_ADVANCED_ROUTER=y \
       CONFIG_IP_FIB_HASH=y
endef

define KernelPackage/advance_route/description
 kernel support for ADVANCE ROUTING and  FIB HASH
endef

$(eval $(call KernelPackage,advance_route))
