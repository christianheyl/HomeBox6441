...
$(call KernelPackage/ipt/Depends,)
  TITLE:=Module for user-space packet logging (Support both IPv4 and IPv6)
  KCONFIG:=$(KCONFIG_IPT_NFLOG)
  FILES:=$(foreach mod,$(IPT_NFLOG-m),$(LINUX_DIR)/net/$(mod).$(LINUX_KMOD_SUFFIX))
  AUTOLOAD:=$(call AutoLoad,45,$(notdir $(IPT_NFLOG-m)))
endef

define KernelPackage/ipt-nflog/description
 Netfilter module for user-space packet logging (Support both IPv4 and IPv6)
 Includes:
 - NFLOG
endef
