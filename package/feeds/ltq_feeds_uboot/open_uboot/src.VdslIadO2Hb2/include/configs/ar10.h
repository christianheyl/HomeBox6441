...
#define CONFIG_ENV_SECT_SIZE 0x1000
   ...
   #define IFX_CFG_FLASH_DDR_CFG_START_ADDR      0x00004fe0 //(CONFIG_SYS_NAND_U_BOOT_SIZE-32)
   #define IFX_CFG_FLASH_DDR_CFG_SIZE            0x20	//32(decimal)=0x20
   #define IFX_CFG_FLASH_DDR_CFG_END_ADDR        0x00004fff //(CONFIG_SYS_NAND_U_BOOT_SIZE-1)
 #endif
#endif
#endif
...
/*define u-boot env range, only meaningful for nand flash*/
  ...
  #else
     // #define CONFIG_ENV_RANGE            0x80000 // james_yang
     #define CONFIG_ENV_RANGE            0x40000
  #endif
#else
  #ifdef CONFIG_ENV_REDUND
