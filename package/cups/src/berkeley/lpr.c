     ...
     char *argv[])			/* I - Command-line arguments */
{
  ...
  for (i = 1; i < argc; i ++)
...
#else
            _cupsLangPrintf(stderr,_("%s: Sorry, no encryption support compiled in!\n"),
	                    argv[0]);
#endif /* HAVE_SSL */
	    break;
	...
	case 'r' : /* Remove file after printing */
		...
		LPR_DBG("set Destination printer or class\n");	
	    if (argv[i][2] != '\0')
	      printer = argv[i] + 2;
	    else
	    {
