...
typedef struct {
    ...
    A_UINT8   txrxgain;								//  1B
    A_UINT8   futureBiModal[MAX_BIMODAL_FUTURE];    // 127B  
...
//The Structure below right now is just supported for BIG endian system, need to enchance it for Little endian system.
typedef union {
    A_UINT8   ctlEdgePwr;
    struct {
		A_UINT8	flag  :2,
