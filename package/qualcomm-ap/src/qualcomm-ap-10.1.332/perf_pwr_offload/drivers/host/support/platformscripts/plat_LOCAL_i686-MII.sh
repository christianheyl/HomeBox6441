#!/bin/sh
#
# Platform-Dependent load script for x86 systems using MII interface
# 
#
...
case $1 in
	...
	echo "loadbus called"
	#
	# TODO : load any supporting kernel modules for MII
	#
	;;
	unloadbus)
	
	echo "unloadbus called"
	#
	# TODO : unload any supporting kernel modules for MII
	#
	;;
	loadAR6K)
