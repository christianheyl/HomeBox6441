...
//
//	Dword	Fields
//	0	reserved_0a[1:0], error_radar[2], reserved_0b[3], reserved_0c[4], error_ofdm_timing[5], error_ofdm_signal_parity[6], error_ofdm_rate_illegal[7], error_ofdm_length_illegal[8], reserved_0d[9], error_ofdm_service[10], reserved_0e[11], error_cck_blocker[12], error_cck_timing[13], error_cck_header_crc[14], error_cck_rate_illegal[15], error_cck_length_illegal[16], reserved_0f[17], error_cck_service[18], reserved_0g[19], error_ht_crc_err[20], error_ht_length_illegal[21], error_ht_rate_illegal[22], error_ht_zlf[23], error_false_radar_ext[24], error_green_field[25], error_spectral_scan[26], error_rx_bw_gt_dyn_bw[27], error_leg_ht_mismatch[28], error_vht_crc_error[29], error_vht_siga_unsupported[30], error_vht_lsig_len_invalid[31]
//	1	error_vht_ndp_or_zlf[0], error_vht_nsym_lt_zero[1], error_vht_rx_extra_symbol_mismatch[2], error_vht_rx_skip_group_id0[3], error_vht_rx_skip_group_id1to62[4], error_vht_rx_skip_group_id63[5], error_ofdm_ldpc_decoder_disabled[6], error_defer_nap[7], error_fdomain_timeout[8], error_lsig_rel_check[9], reserved_1[31:10]
//	2	phy_timestamp_1[31:0]
//	3	phy_timestamp_2[31:0]
//
// ################ END SUMMARY #################

#define NUM_OF_DWORDS_RX_PHY_PPDU_END 4
...
/* Description		RX_PHY_PPDU_END_0_RESERVED_0B
			
*/
#define RX_PHY_PPDU_END_0_RESERVED_0B_OFFSET                         0x00000000
#define RX_PHY_PPDU_END_0_RESERVED_0B_LSB                            3
#define RX_PHY_PPDU_END_0_RESERVED_0B_MASK                           0x00000008

/* Description		RX_PHY_PPDU_END_0_RESERVED_0C
			
*/
#define RX_PHY_PPDU_END_0_RESERVED_0C_OFFSET                         0x00000000
#define RX_PHY_PPDU_END_0_RESERVED_0C_LSB                            4
#define RX_PHY_PPDU_END_0_RESERVED_0C_MASK                           0x00000010
...
/* Description		RX_PHY_PPDU_END_0_RESERVED_0D
			
*/
#define RX_PHY_PPDU_END_0_RESERVED_0D_OFFSET                         0x00000000
#define RX_PHY_PPDU_END_0_RESERVED_0D_LSB                            9
#define RX_PHY_PPDU_END_0_RESERVED_0D_MASK                           0x00000200
...
/* Description		RX_PHY_PPDU_END_0_RESERVED_0E
			
*/
#define RX_PHY_PPDU_END_0_RESERVED_0E_OFFSET                         0x00000000
#define RX_PHY_PPDU_END_0_RESERVED_0E_LSB                            11
#define RX_PHY_PPDU_END_0_RESERVED_0E_MASK                           0x00000800
...
/* Description		RX_PHY_PPDU_END_0_RESERVED_0F
			
*/
#define RX_PHY_PPDU_END_0_RESERVED_0F_OFFSET                         0x00000000
#define RX_PHY_PPDU_END_0_RESERVED_0F_LSB                            17
#define RX_PHY_PPDU_END_0_RESERVED_0F_MASK                           0x00020000
...
/* Description		RX_PHY_PPDU_END_0_RESERVED_0G
			
*/
#define RX_PHY_PPDU_END_0_RESERVED_0G_OFFSET                         0x00000000
#define RX_PHY_PPDU_END_0_RESERVED_0G_LSB                            19
#define RX_PHY_PPDU_END_0_RESERVED_0G_MASK                           0x00080000
...
#define RX_PHY_PPDU_END_1_RESERVED_1_LSB                             10
#define RX_PHY_PPDU_END_1_RESERVED_1_MASK                            0xfffffc00

/* Description		RX_PHY_PPDU_END_2_PHY_TIMESTAMP_1
			...
			the rest of the MAC.
*/
#define RX_PHY_PPDU_END_2_PHY_TIMESTAMP_1_OFFSET                     0x00000008
#define RX_PHY_PPDU_END_2_PHY_TIMESTAMP_1_LSB                        0
#define RX_PHY_PPDU_END_2_PHY_TIMESTAMP_1_MASK                       0xffffffff

/* Description		RX_PHY_PPDU_END_3_PHY_TIMESTAMP_2
			...
			by the AMPI before being forwarded to the rest of the MAC.
*/
#define RX_PHY_PPDU_END_3_PHY_TIMESTAMP_2_OFFSET                     0x0000000c
#define RX_PHY_PPDU_END_3_PHY_TIMESTAMP_2_LSB                        0
#define RX_PHY_PPDU_END_3_PHY_TIMESTAMP_2_MASK                       0xffffffff
