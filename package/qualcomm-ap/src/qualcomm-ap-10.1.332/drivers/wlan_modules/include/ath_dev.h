 ...
 */
  ...
  */
   ...
   */
#if UMAC_SUPPORT_WNM
    int         (*update_beacon)(ieee80211_handle_t, int if_id, ieee80211_beacon_offset_t *bo, wbuf_t wbuf, int mcast, u_int32_t nfmsq_mask);
#else
...
#define ATH_ISR_NOTMINE         0x0002  /* This was not my interrupt - for shared IRQ's    */
  ...
  /**
	...
	/**
     * Get duty cycle on the control channel.
     * @param dev : handle to LMAC device
	...
	/**
     * Get duty cycle on the extension channel
     * @param dev : handle to LMAC device
     * @return the duty cycle .
     */
...
#endif
    u_int8_t*   (*get_tpc_tables)(ath_dev_t dev);
