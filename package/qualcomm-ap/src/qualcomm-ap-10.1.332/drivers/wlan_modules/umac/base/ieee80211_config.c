...
wlan_set_param(wlan_if_t vaphandle, ieee80211_param param, u_int32_t val)
{
    ...
    case IEEE80211_MAX_CLIENT_NUMBERS:
        vap->iv_maximum_clients_number = (u_int16_t)val;
        break;
    ...
    break;
    case IEEE80211_ENABLE_OL_STATS:
        if (ic->ic_ath_enable_ap_stats)
            if (ic->ic_ath_enable_ap_stats(ic, val)) {
                return -EINVAL;
            } else {
                return 0;
            }
...
wlan_get_param(wlan_if_t vaphandle, ieee80211_param param)
{
    ...
    case IEEE80211_WEATHER_RADAR:
        ...
        break;
    case IEEE80211_MAX_CLIENT_NUMBERS:
        val = vap->iv_maximum_clients_number;
        break;
    case IEEE80211_WEP_KEYCACHE:
...
int wlan_get_maxphyrate(wlan_if_t vaphandle)
{
 struct ieee80211vap *vap = vaphandle;
 struct ieee80211com *ic = vap->iv_ic; 
 return(ic->ic_get_maxphyrate(ic, vap->iv_bss) * 1000);
} 
