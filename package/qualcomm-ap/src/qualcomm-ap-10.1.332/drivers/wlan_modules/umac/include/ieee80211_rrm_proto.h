...
typedef struct ieee80211_rrm
{
    ...
    int8_t                              rrm_noisefloor[IEEE80211_CHAN_MAX]; /* calulation of noise */
    int8_t                              u_chload[IEEE80211_CHAN_MAX]; /*channl load storage to feed to user layer */
    ieee80211_rrm_noise_data_t          user_nhist_resp[IEEE80211_CHAN_MAX]; /* user layer feed after report received on ap side */
    u_int32_t                           rrm_chan_load[IEEE80211_CHAN_MAX];  /*channel load calculation through scan module */
    u_int32_t                           rrm_cycle_count[IEEE80211_CHAN_MAX];
