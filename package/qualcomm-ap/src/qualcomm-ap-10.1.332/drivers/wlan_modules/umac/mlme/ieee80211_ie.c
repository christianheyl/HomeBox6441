...
ieee80211_add_mmie(struct ieee80211vap *vap, u_int8_t *bfrm, u_int32_t len)
{
    ...
    /* A1 || A2 || A3 */
    memcpy(aad + 2, wh->i_addr1, 3 * IEEE80211_ADDR_LEN);    
...
ieee80211_set_vht_rates(struct ieee80211com *ic, struct ieee80211vap  *vap)
{
    ...
    switch (rx_streams) {
        ...
        case 3:
            /* Tri stream */
            /* 
             * Workaround to disable Rx NSS3 MCS8/9 temporary on Lantiq platform.
             * For get stable TCP UPLINK throughput number.
             */
            ic->ic_vhtcap_max_mcs.rx_mcs_set.mcs_map = 0xffca;
