...
int
htt_rx_msdu_rx_attention_retrieve_ll(htt_pdev_handle pdev, adf_nbuf_t msdu)
{
    struct htt_host_rx_desc_base *rx_desc;
    rx_desc = htt_rx_desc(msdu);
    return (*((u_int32_t *) &rx_desc->attention));
}

int
htt_rx_msdu_rx_attention_retrieve_hl(htt_pdev_handle pdev, adf_nbuf_t msdu)
{
...
int (*htt_rx_msdu_rx_attention_retrieve)(
...
htt_rx_attach(struct htt_pdev_t *pdev)
{
    ...
    if (!pdev->cfg.is_high_latency) {
        ...
        *pdev->rx_ring.alloc_idx.vaddr = 0;
        ...
        htt_rx_msdu_rx_attention_retrieve = htt_rx_msdu_rx_attention_retrieve_ll;
        ...
        htt_rx_msdu_rx_attention_retrieve = htt_rx_msdu_rx_attention_retrieve_hl;
