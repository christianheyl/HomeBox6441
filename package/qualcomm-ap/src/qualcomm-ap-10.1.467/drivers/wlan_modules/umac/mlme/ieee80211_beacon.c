                      ...
                      u_int8_t *frm)
{
    ...
    *frm++ = IEEE80211_ELEMID_SSID;
     ...
     * VHT capable : 
     */
    if (ieee80211_vap_wme_is_set(vap) && IEEE80211_IS_CHAN_11AC(vap->iv_bsschan) && ieee80211vap_vhtallowed(vap)) {
...
#endif
{
    ...
    *bo->bo_caps = htole16(capinfo);
     ...
     */
    if (ieee80211_vap_wme_is_set(vap) && 
        IEEE80211_IS_CHAN_11AC(vap->iv_bsschan) && ieee80211vap_vhtallowed(vap)) {
