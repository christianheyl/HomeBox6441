...
#define QC98XX_EEP_VER3             3
#define QC98XX_EEP_VER              QC98XX_EEP_VER3
...
#define WHAL_BOARD_FLAG1_NOISE_FLOOR_THR_MASK   0x10
#define WHAL_BOARD_FLAG1_NOISE_FLOOR_THR_SHIFT  4
