...
typedef struct osSockInfo {
	...
	GUID  m_intfGuid;
    A_INT32 osMajorVersion;
    A_INT32 osMinorVersion;
#endif
...
#if (defined(ANWI) || defined(_WINDOWS))
...
#define WMI_FUNCTION	4
#define ETH_FUNCTION	5
