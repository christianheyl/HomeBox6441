//This is an auto-generated file, from the given header file ../../../../../../../include/systemtools/common/rspGenericParms.h //for parsing the tx cmd parms in the binary stream
