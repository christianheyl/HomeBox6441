//This is an auto-generated file, from the given header file ../../../../../../../include/systemtools/common/cmdCalDoneParms.h //for parsing the tx cmd parms in the binary stream
