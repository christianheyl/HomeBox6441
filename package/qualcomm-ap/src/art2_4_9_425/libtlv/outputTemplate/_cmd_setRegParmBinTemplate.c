//This is an auto-generated file, from the given header file ../../../../../../../include/systemtools/common/cmdSetRegParms.h //for parsing the tx cmd parms in the binary stream
