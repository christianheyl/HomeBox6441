...
extern int do_upgrade(int flag, int argc, char *argv[]);
extern int program_img(ulong srcAddr,int srcLen,ulong destAddr);
extern int upgrade_img(ulong srcAddr,ulong srcLen,char *imgName,enum ExpandDir dir,int bSaveEnv);/*000001:Nirav*/
