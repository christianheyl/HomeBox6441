...
int is_slow_nat_port(SLOW_NAT_PROTO proto, u_int16_t port)
{
    int i;
/* 
URL blocking will make upstream packets with port 80,443,53 goes slow path.
In our testing, if we do a http download, the US ack would go to slow path.
This will increase CPU loading dramtically.
Thus we remarked this part as a Work-Around.
*/
#if 0
    switch(proto) {
